...
export default function Checkout() {
   ...
   // 로그인된 정보
   if (myCon.loginSts) {// 로그인상태이면  member에 데이터 저장
   ...
   return (
      ...
      <div className="checkout-area inbox">
            ...
            <div className="customer-info">
               ...
               {member ? (
                  <div className="member-info">
                     ...
                     <span>
                        <strong>주소:</strong>{" "}
                        {`[${member.zcode}] ${member.addr}`}
                     </span>
                     <button className="addr-change">변경</button>
                     ...
                     <div className="member-info">
                        <p>
                           <label className="default" htmlFor="name">
                              주문자명: <input id="name" type="text"></input>
                           </label>
                        </p>
                        <p>
                           <label className="default" htmlFor="number">
                              전화번호: <input id="number" type="text"></input>
                           </label>
                        </p>
                        <p>
         ...
         <button className="checkout-button" onClick={()=> alert("결제기능이 준비중 입니다.")}>결제하기</button>
      </div>
   );
} //////////// Checkout 컴포넌트 ////////
