   ...
   return (
      <div id="cart-page">
         <section
            ...
            onClick={(e) => {
              /* 카드열기 */
               $(".cart-page").css({ translate: "-100%", transition: "0.3s" ,pointerEvents: "all"  });
               $("#cart-page")
               .css({ background:"rgba(0, 0, 0, 0.4)",transition: "0.3s",  pointerEvents: "none"  });
            }}
         >
            <p>CART</p>
         </section>
         <section className="cart-page">
            <div className="item-list">
               ...
               <div className="info-wrap">
                  <h3>Your Cart List: 4 items </h3>
                  <p className="close"
                  onClick={(e)=>{
                    /* 카드닫기 */
                    $("#cart-page")
                   .css({ background:"rgba(0, 0, 0, 0)",transition: "0.3s" });
                    $(".cart-page").css({ translate: "0%", transition: "0.3s", pointerEvents: "all" });
                  }}
                  >X</p>
