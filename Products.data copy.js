const AllProducts = [
    ...
    type: "GIFTING" ,
    collection: "British Tales" ,
    name: ["펜할리곤스 베스트셀러 센트 라이브러리 (2mlx10)" ,"Best-selling cents library"],
    info: ["펜할리곤스의 가장 멋진 향기 10종을  미니시리즈로 만나보세요. 당신에게 향의 지식을 전해줄 진정한  라이브러리 입니다.","Discover 10 of Penhaligons' most stunning scents in a miniseries - a veritable library of fragrance knowledge."],
    price: " 62,000" ,
    img: "products_3.jpg"
    } ,
    {
    ...
    info: ["안목 있는 신사를 위한 완벽한 향수 세트, 사랑스러운 5ml 미니어처 보틀에 담긴 특별한 사람 또는 자신을 위한 완벽한 선물입니다.","The perfect fragrance set for the discerning gentleman, The perfect gift for that special someone, or for yourself, in a lovely 5ml miniature bottle."],
    price: " 89,000" ,
    img: "products_52.jpg"
    } ,
    {
    ...
    type: "GIFTING" ,
    collection: "Portraits" ,
    name: ["펜할리곤스 포트레이트 센트 라이브러리 (10x2ml)" ,"Portrait Cent Library"],
    info: ["리틀 럭셔리 라이브러리에는 펜할리곤스의 아름다운 포트레이트 라인 미니시리즈의 클래식한 향 10종이 담겨 있습니다.","The Little Luxury Library features 10 classic scents from Penhaligons' beautiful Portrait Line miniseries."],
    price: " 71,000" ,
    img: "products_53.jpg"
    } ,
    {
    ...
    info: ["영국 포트레이트 가문의 멘션에서 벌어지고 있는 비밀스러운 스캔들과 매혹적인 향기가 가득한 포트레이트 럭셔리 컬렉션으로 당신을 초대합니다.","The Portrait Luxury Collection invites you to discover the secret scandals and seductive fragrances of the British Portrait family."],
    price: "302,000" ,
    img: "products_70.jpg"
    } ,
    {
