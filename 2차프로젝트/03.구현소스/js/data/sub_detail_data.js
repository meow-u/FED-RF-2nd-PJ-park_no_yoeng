...
const collection_detail = [
   {
      ...
      tit: ["The British Tales Collection", ""],
      text: [`가장 영국적인 감성과 고전 그리고 이야기를 담아낸 컬렉션입니다.`,``,``,``,``],
   ...
   },
   {
      ...
      tit: ["Trade Routes Collection", ""],
      text: [`무역업이 활발했던 19세기 런던 항구를 가득 채운 비단, 향신료, 진귀한 목재 등 고급 무역품에서 영감을 받은 컬렉션입니다.`,``,``,``,``],
   ...
   },
   {
      ...
      tit: ["Potions & Remedies", ""],
      text: [`윌리엄 펜할리곤의 비밀 실험실에서 제조되는 특별한 치료법을 담아낸 컬렉션입니다.`,``,``,``,``],
